    ...
    <div>
        ...
        <div class="flex min-h-screen items-start" style="background: var(--bg)">
            ...
            <div class="flex min-w-0 flex-1 flex-col">
                ...
                >
                    <span>You are impersonating this organization. This session is audit-logged and time-limited; billing, credential, and account/organization-deletion actions are blocked.</span>
                    <Link

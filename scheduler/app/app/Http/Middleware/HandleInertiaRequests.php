...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            // `planKey()` is the *effective* plan (a platform-admin override
            // wins over the raw Stripe-synced `team.plan` while active) — the
            // sidebar must reflect what the organization can actually do
            // right now, not what Stripe has on file.
            'planName' => fn () => $request->user() && $team ? ucfirst(app(PlanService::class)->planKey($team)) : null,
